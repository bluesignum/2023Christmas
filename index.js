...
const modalMessageList = [
  ...
  { "number": 7, "message": "좋은 것들은 목청 큰 불행들 사이에 갸냘프게 끼어온다는 문장을 읽은 적이 있어. 아무래도 올해가 나한테 그런 해인걸까? 나도, 너에게 이해받아 훨씬 덜 외로운 한 해였어. 그치만 네가 나의 모든 상징을 이해하지는 못했으면 좋겠다고 가끔 생각해. 좋은 것만 주고 좋은 면만 보여줄 수 없어 아쉽다. 그치만 우리가 떨어져있지 않으면 불가능한거니까, 그건 포기할래 ㅎㅎ" },
  { "number": 8, "message": "17일행복의 파도가 모두에게 찾아오는 특별한 24일!" },
