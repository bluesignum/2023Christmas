...
const modalMessageList = [
  ...
  { "number": 13, "message": "블시에서 크리스마스 파티하는 날! 슬쩍 보는 게 내가 할 수 있는 대부분이지만 그래도 네가 있어서 늘 응원과 위안이 되고 힘든 날도 버틸 수 있는 것 같아. 내가 원할 때까지 있어주겠다고 해서 고마워. 혹시 지켜지기 어렵더라도 그 말을 하게 된 네 마음이 따뜻하게 와닿았던 것 같아. 가끔 아마도 아쉽고 답답한 때가 있을 수 있겠지만 그래도 너는 늘 응원해주면 좋겠다. 나도 네가 행복하게 지낼 수 있게 최선을 다해볼게! 오늘은 이기적인 말을 써봤어..ㅎㅎ 파티에서 재밌게 시간 보내고 같이 집에 가서 오붓하게 쉬자!" },
  { "number": 14, "message": "벌써 내일이면 크리스마스 이브야! 전에는 크리스마스가 그냥 휴일 그 이상도 이하도 아니었는데 너 덕분에 설레는 날이 됐어. 그렇게 일년을 차곡차곡 특별한 날들로 채울 때까지 행복하게 만나자. 더 오래 행복하고 서로 힘들 때 의지할 수 있는 사이가 되고싶어. 너의 첫사랑이고 싶지만, 그래도 조금 더 너를 따뜻하게 대할 수 있는 사람일 때 만나서 행운이라고 생각해. 사랑해, 선하야" },
  { "number": 15, "message": "여행을 떠나는 날이야! 즐겁고 안전히 다녀오자. 눈 덮인 산에 대해 생각해본 건 올해가 처음이지만 아마 나도 좋아하게 될 것 같아. 이미 그렇게 된 것 같기도 해. 눈오는 날이 제일 좋아하는 날씨중 하나가 된 것처럼. 네가 좋아하는 것들과 너에게 소중한 것들은 곧잘 나에게도 그렇게 되니까. 그리고 이건 비밀인데, 너랑 있으면 매일이 아주 근사한 여행같아." },
