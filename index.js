...
const modalMessageList = [
  ...
  { "number": 12, "message": "너는 예쁘고 사랑스러워. 생각하는 것들, 느끼는 것들도 예쁘고, 무언가를 사랑하는 마음도 예뻐. 좋은 사람이 되기 위해 노력하는 너를 본받고 싶고, 멋지다고 생각해. 네가 너무 사랑스러워서 왠지 너를 생각하면 새롭고 재미있는 걸 뭐든 할 수 있을 것만 같아. 행복에 대해 늘 고민하면서 살아왔는데 너랑 있으면 고민할 새도 없이 행복이 너무 쉽게 느껴져. 너한테 내 모든 삶이 위로받는 기분이야. 운명같은 거 시덥잖은 소리라고 생각했지만 요즘엔 조금 더 믿게 됐어." },
