...
const modalMessageList = [
  ...
  { "number": 14, "message": "블시에서 크리스마스 파티하는 날! 슬쩍 보는 게 내가 할 수 있는 대부분이지만 그래도 네가 있어서 늘 응원과 위안이 되고 힘든 날도 버틸 수 있는 것 같아. 내가 필요할 때까지 있어주겠다는 말이, 혹시 지켜지기 어렵더라도 그 말을 하게 된 네 마음이 따뜻하게 와닿아서 고마워. 어느 날 아마도 아쉽고 답답한 때가 있을 수 있겠지만 그래도 너는 늘 응원해주면 좋겠다. 오늘은 이기적인 말을 써봤어..ㅎㅎ 오늘 재밌게 시간 보내고 같이 집에 가서 오붓하게 쉬자!" },
