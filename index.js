...
const modalMessageList = [
  ...
  { "number": 9, "message": "선하야, 안녕. 오늘은 어땠어? 나는 요즘 매일 너를 더 사랑하는 기분인데, 그게 끝없이 올라가고 있어서 신기해. 그리고 편지를 쓸 때마다 생각보다 너에 대한 감정을 표현하는 게 생각보다 어렵다고 느껴. 기억도 나지 않을만큼 어렸을 때 느꼈던, 온전히 순수한 사랑과 애정이 이런 느낌이었을까? 강아지가 사람을 좋아하는게 이런 느낌인걸까? 뭔가 마음 깊은 곳에서 따뜻한 느낌이 올라오는데, 한 번도 경험한 적 없으면서도 아무런 장벽없이 받아들이게 돼. 네가 웃으면 온 세상이 밝아지고 알록달록해져. 다른 누군가를 이 이상 사랑할 수 있을 것 같지 않아. 이런 감정은 처음인 것 같아. 사랑해, 선하야. " },
