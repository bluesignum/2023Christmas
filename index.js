...
const modalMessageList = [
  ...
  { "number": 14, "message": "벌써 내일이면 크리스마스 이브야! 전에는 크리스마스가 그냥 휴일 그 이상도 이하도 아니었는데 너 덕분에 설레는 날이 됐어. 그렇게 일년을 차곡차곡 특별한 날들로 채울 때까지 행복하게 만나자. 더 오래 행복하고 서로 힘들 때 의지할 수 있는 사이가 되고싶이. 너의 첫사랑이고 싶지만, 그래도 조금 더 너를 따뜻하게 대할 수 있는 사람일 때 만나서 행운이라고 생각해. 사랑해, 선하야" },
