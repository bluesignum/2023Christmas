...
const modalMessageList = [
  ...
  { "number": 9, "message": "" },
  { "number": 10, "message": "새롭고 재미있는 걸 할 수 있을 것만 같은 기분이야. 세상의 멋진 것들, 예쁜 것들을 같이 보고 듣고 경험하고 싶어. 해질녁이 예쁜 날에 너랑 야외 테라스가 있는 식당에 앉아 맛있는 식사를 하고 도란도란 이야기하고싶어. 19일모두에게 행복이 넘치는 24일을 기대해봐요." },
