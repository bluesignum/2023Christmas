...
const modalMessageList = [
  ...
  { "number": 8, "message": "가끔은 우리가 정말 많이 닮았다는 생각을 해. 너의 모습을 보면서 나를 보고, 그래서 어쩌면 너를 사랑하는 건 나를 더 사랑해가는 과정이지 않을까 싶어. 나도 나를 어쩔줄 모르니까 네가 그만큼 어렵지만, 또 그만큼 너를 이해하고, 또 더 사랑하게 돼. 우리도 아마 깊은 곳에서는 우리 스스로를 안쓰러워하고 사랑하고있지 않을까? 그러니까 너를 알아갈수록 네가 좋다는건 정말로 진심이야. 그러니까 혹시 어떤 날은 힘들어도 놓지말고 꼭 잡고있어줘. 나도 너를 잘 잡고 있을게. 그렇게 시간이 흐르면 우리 스스로를 정말로 사랑하게 될지도 모르잖아?"},
