...
const modalMessageList = [
  { "number": 1, "message": "선하야, 안녕! 이걸 너한테 공개하는 순간이 오다니,, 벌써 전에 블시에서 받았던 피드백들이 스쳐지나가면서 약간 두렵다,,☆ 그치만 정성과 사랑으로 예쁘게 봐주면 좋겠어! 10일에 주려고 했지만 조금 늦어서 12일이 됐네 ㅠ 그치만 3일만큼을 한꺼번에 볼 수 있으니까!ㅎㅎ 앞으로 남은 날들도 한번씩 들여다봐줘 ㅎ" },
